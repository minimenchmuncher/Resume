...
\location {to develop a model for assessing risk of loss for insurance policies or lenders}
\vspace{\topsep}
\begin{tightemize}
...
\descript {Energetic Capital}
\location {to migrate company's codebase from R to Python}
\begin{tightemize}
...
\location {to help manage internal process for 2017 All-Source Solicitation}
\begin{tightemize}
